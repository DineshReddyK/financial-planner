...
st.subheader("Remaining Balance", divider="gray")
col1, col2 = st.columns(2)
...
st.subheader("Investment Portpolio", divider="gray")
col1, col2 = st.columns(2)
...
st.subheader("Financial Planinng", divider="gray")
...
cur_lumpsom_inv = col2.number_input("Current Saving Amount (Lumpsum Investment)", min_value=1, value=500000)
post_ret_amount_need = col1.number_input("Amount Need Per Month Post Retirement", min_value=1, value=80000)
...
with st.form("Additioanl Expenses"):
    m_age = st.selectbox("At what age you expect this?:", retirement_plan_df['Age'])
